 ...
 * @author DELL
 */
public class ViewQuestionDetailsController extends HttpServlet {

    private static final String ERROR = "error.jsp";
    private static final String SUCCESS = "viewQuestionDetails.jsp";
    private static final Logger LOGGER = Logger.getLogger(ViewQuestionDetailsController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (question != null) {
                ...
                request.setAttribute("ERROR", "Can not found question details!");
            }
        } catch (Exception e) {
            LOGGER.error("Error at ViewQuestionDetailsController: " + e.getMessage());
        } finally {
